        ...
        <div id="carouselExampleIndicators" class="carousel slide boxCaruselMainHome" data-bs-ride="carousel">
            <div class="carousel-indicators btnItemCaruselMainHome">
                ...
                @foreach ($viewSlayderMain as $itemBtn)
                    ...
                    @endphp
                    @if ($slayBtn === 1)
                        <button type="button" data-bs-target="#items" data-bs-slide-to="0" class="active btnCaruselMainHome"
                            aria-current="true" aria-label="Slide 1"></button>
                    @else
                        <button type="button" class="btnCaruselMainHome" data-bs-target="#items"
                            data-bs-slide-to="{{ $slayBtn - 1 }}" aria-label="Slide {{ $slayBtn }}"></button>
                    @endif
                @endforeach
