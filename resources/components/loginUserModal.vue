<template>
    ...
    <div class="modal fade modal-destino boxContainerModalUser modalEfectGlass" id="loginUserModal" aria-hidden="true"
        aria-labelledby="loginUserM" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal--frm--userLog">
            <div class="modal-content ">
                <form class="shadow form--frm--userLog col-md-12 col-12 p-4 rounded-3" id="formLoginUser" action=""
                    ...
                    <div class="mb-3">
                        <input type="email" class="form-control input--frm--userLog" id="emailLoginUser"
                            v-model="formData.email" placeholder="Correo electronico " required />
                    </div>
                    <div class="mb-3">
                        ...
                        <img :src="imgShowPassword" class="frm--loginUser--img imgPasswordLoginUser" id="imgPassLoginUser"
                    ...
                    <div class="mb-3 text-center">
                        <a href="/login/google" class="form-control- mb-3 googleBody- "><img
                                :src="`/storage/img/icons/logoGoogle.png`" alt="" class="logoSesion me-2"> </a>
                        <a href="#" class="form-control- mb-3 facebookBody- "><img :src="`/storage/img/icons/logoFb.svg`"
                                width="30px" class="logoSesion img-fluid me-2" alt=""></a>
                    </div>
                    <hr>
